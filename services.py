...
Fee math (ECON-01..ECON-04), lazy settlement materialization, and the
public-base-URL helper. The fee functions are protocol contracts —
they must be preserved exactly from the source (rounding UP, fee-aware
bounds, melt fee budget). No function here logs a spendable credential
or full request URL (SEC-05).
"""
